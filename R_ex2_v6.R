...
## SCENARIO 1 WITH ADAPTIVE THERAPY: FIXED DOSE (10 DAYS)
## EVERY 2 DAYS
...
## SCENARIO 2 WITH ADAPTIVE THERAPY: TURN THE TREATMENT ON/OFF
## DEPENDING ON THE TOTAL NUMBER OF CELLS
...
fit_cells4 <-data.frame(Genotype = c("WT", "S", "R", "S, R"),
                       Fitness = c(wt_fitness,                              #WT
                                   ...
                                   # work because drug is assigned 'true'
                                   # in each iteration)
                                   paste0("var drug := true;
                                           if (T>50 & N>500 & drug = true)",
                                          drug_eff2, "* (", sens_fitness,");
                                           else if (T>50 & N=500) drug := false;
                                           else if (T>50 & N=2500) drug := true;
                                           else ", sens_fitness, ";"),          #S
                                   "0",                                        #R   
                                   res_fitness),                               #S,R
                       stringsAsFactors = FALSE)
...
## SCENARIO 3 WITH ADAPTIVE THERAPY: INTERVENTION THAT
...
## SCENARIO 4 WITH ADAPTIVE THERAPY: INTERVENTION THAT
## DEPENDS ON TIME
